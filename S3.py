...
def jovan():
    ...
    {green} 
                 ...
                 {white} https://boostbayan.com
     {red}──────────────────────────────────────────────────────────────────────\033[0m
     {red}OWNER     {white}: {yellow} Mark Ballerda G.
     {red}FACEBOOK  {white}: {yellow} Jai Gvanci
     {red}──────────────────────────────────────────────────────────────────────\033[0m""")
def main():
	clear()
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
                  """,
           title=f"{Y}COOKIE GETTER", subtitle=f"{R}DEVELOP BY M A R K ", border_style="bold yellow"))
...
{lightblue}│  {hotpink}           ░░╚██╔╝░░  ██║  ██║░░██║  ╚██████╔╝  ██████╔╝{lightblue}                │
{lightblue}│  {hotpink}           ░░░╚═╝░░░  ╚═╝  ╚═╝░░╚═╝  ░╚═════╝░  ╚═════╝░{lightblue}                │
{lightblue}│                       BOOSTING TOOL{green} NOT FOR {hotpink}FREE                {blue}         │
{lightblue}│                  ╭─────────────────────────────────╮                {lightblue}     │
{lightblue}╰──────────────────│{C}   D E V E L O P E R  M A R K   {lightblue} │─────────────────────╯
 {lightblue}      ╰───────────────────────────────────────────────────────────╯
 ╭────────{C}TOOL INFORMATION{B}─────────╮ {blue}   ╭────────{C}USER INFORMATION{B}─────────╮
 │ {red}•{hotpink} OWNER   : {green}M A R K         {blue}    │   {blue} │ {red}• {hotpink}STATUS   : {green}ACTIVE        {blue}     │
 │{red} • {hotpink}USES    : {green}BOOSTING       {blue}     │ {blue}   │ {red}• {hotpink}COUNTRY  :{green} PHILIPPINES    {blue}    │
 │{red} • {hotpink}NETWORK : {green}ALL NETWORK     {blue}    │   {blue} │ {red}• {hotpink}TELEGRAM : {green}@BoostBayan PH   {blue}  │
 │ {red}• {hotpink}VERSION : {green}10.0      {blue}           │{blue}   │ {red}• {hotpink}LICENSE : {green}DSE26P0L7DQ  {blue}       │
 ╰─────────────────────────────────╯    ╰─────────────────────────────────╯""")
purple = "\033[1;35m"
blue = "\033[34m"
green = "\033[1;32m"
...
def main():
    ...
    print(f"{lightblue}┃  {green}[01]  {hotpink}Start Tools                            {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[02]  {hotpink}AUTO REACT POST                        {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[03]  {hotpink}AUTO REACT REELS                       {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[04]  {hotpink}AUTO REACT GROUP POST                  {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[05]  {hotpink}AUTO REACT [ VIDEO OR PHOTO ]          {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[06]  {hotpink}AUTO FOLLOW                            {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[07]  {hotpink}AUTO REACT DP/POST                     {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[08]  {hotpink}AUTO COMMENTS                          {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[09]  {hotpink}AUTO FOLLOW & LIKE PAGE                {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[10]  {hotpink}AUTO SHARE [ VIA COOKIES ]             {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[11]  {hotpink}AUTO REACT COMMENTS                    {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[12]  {hotpink}AUTO REPLY COMMENTS                    {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[13]  {hotpink}AUTO REACT POST ( W/CARE )             {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[14]  {hotpink}AUTO GROUP JOIN                        {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[15]  {hotpink}AUTO REACT LIVE STREAM                 {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[16]  {hotpink}AUTO COMMENT LIVE STREAM               {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[17]  {hotpink}RESET TOOLS                            {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[18]  {hotpink}AUTO CREATE PAGE                       {yellow}❏ {green}[ PHILIPPINE NAME ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[19]  {hotpink}AUTO SET PFOFILE                       {yellow}❏ {green}[ RANDOM ]               {lightblue}┃")
    print(f"{lightblue}┃  {green}[20]  {hotpink}CREATE FILE                            {yellow}❏ {green}[ RANDOM ]               {lightblue}┃")
    print(f"{lightblue}┃  {green}[21]  {hotpink}REMOVE DUPLICATE                       {yellow}❏ {green}[ ACCOUNT REMOVER ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[22]  {hotpink}ACCOUNT CHECKER                        {yellow}❏ {green}[ ACCOUNT CHECKER ]      {lightblue}┃")
    print(f"{lightblue}┃  {green}[23]  {hotpink}VALIDATE TOKEN                         {yellow}❏ {green}[ TOKEN ]                {lightblue}┃")
    print(f"{lightblue}┃  {green}[24]  {hotpink}REDEEM ACCOUNT                         {yellow}❏ {green}[ REDEMPTIONS ]          {lightblue}┃")
    print(f"{lightblue}┃  {green}[25]  {hotpink}AUTO SHARE V1                          {yellow}❏ {green}[ FAST SPEED / BOT ]     {lightblue}┃")
    print(f"{lightblue}┃  {green}[26]  {hotpink}AUTO SHARE V2                          {yellow}❏ {green}[ WITH NOTIFICATION ]    {lightblue}┃")
    print(f"{lightblue}┃  {green}[27]  {hotpink}COOKIES/TOKEN                          {yellow}❏ {green}[ GETTER ]               {lightblue}┃")
    print(f"{lightblue}┃  {green}[28]  {hotpink}FOLLOWER REMOVER                       {yellow}❏ {green}[ REMOVER ]              {lightblue}┃")
    print(f"{lightblue}┃  {green}[29]  {hotpink}AUTO REACT V2 WITH REMOVER             {yellow}❏ {green}[ REMOVER ]              {lightblue}┃")
    print(f"{lightblue}┃  {green}[30]  {hotpink}TOOLS UPDATE                           {yellow}❏ {green}[ UPDATING ]             {lightblue}┃")
    print(f"{lightblue}┃  {green}[31]  {hotpink}AUTO FOLLOW V2                         {yellow}❏ {green}[ PAGE OR ACCOUNT ]      {lightblue}┃")
    print(f"{lightblue}┗━━━{red} ⬤ {yellow}⬤ {green}⬤ {lightblue}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
